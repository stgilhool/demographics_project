import cag_input_data_xiao as cag_input_data
...
n_encoder_hidden_3 = 4
n_decoder_hidden_1 = 4
...
n_encoder_hidden_3 = 100
n_decoder_hidden_1 = 100
n_decoder_hidden_2 = 250
n_decoder_hidden_3 = 500
'''
...
if __name__ == '__main__':
    ...
    cag = cag_input_data.read_data_sets(n_data=n_snp,
        ...
        with tf.variable_scope("autoencoder_model"):
            ...
            for epoch in range(training_epochs):
                ...
                if epoch % display_step == 0:
                    ...
                    saver.save(sess, "cag_autoencoder_hidden=" + n_code + "_logs/model-checkpoint-" + '%04d' % (epoch+1), global_step=global_step)
